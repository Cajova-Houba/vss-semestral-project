...
\item Porovnání s tabulkovou hodnotou. $\chi^2 \le \chi_{tab}^2$ pak hypotézu nelze zamítnout. Jinak hypotézu zamítnu na hladině ppsi $\alpha$.
   ...
   \end{itemize}
	...
	Buňka v automatu popsaném článku může nabývat pouze dvou stavů: spálená a nespálená. Pro drobné zpestření jsem přidal dva stavy navíc, které umožňují rozeznat různé stupně spálenosti. Rozsahy a příslušné obarvení je uvedeno v tabulce \ref{tab:patch-color}.
